...
namespace ProjektSemestralny
{
    ...
    public partial class Wypozyczalnia_Gier_komputerowychEntities1 : DbContext
    {
        public Wypozyczalnia_Gier_komputerowychEntities1()
            : base("name=Wypozyczalnia_Gier_komputerowychEntities1")
        {
        }
